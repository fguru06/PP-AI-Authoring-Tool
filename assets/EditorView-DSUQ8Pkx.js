...
B, 20`}),c.updateElement(r.projectId,r.currentSlideId,d.element.id,h),r.selectElement(d.element.id)}return(b,h)=>{var L;return l(),i("div",km,[e("div",Cm,k(((L=x.element.content)==null?void 0:L.prompt)||"Add Content"),1),e("div",{class:"placeholder-actions",onMousedown:h[4]||(h[4]=Le(()=>{},["stop"]))},[e("button",{onMousedown:h[0]||(h[0]=Le(Y=>p("text"),["stop","prevent"])),title:"Text"},"T",32),e("button",{onMousedown:h[1]||(h[1]=Le(Y=>p("image"),["stop","prevent"])),title:"Image"},"I",32),e("button",{onMousedown:h[2]||(h[2]=Le(Y=>p("video"),["stop","prevent"])),title:"Media"},"M",32),e("button",{onMousedown:h[3]||(h[3]=Le(Y=>p("chart"),["stop","prevent"])),title:"Chart"},"C",32)],32)])}}},$m=Ze(Sm,[["__scopeId","data-v-dda6b3cc"]]),Im={key:0,class:"canvas-empty"},Em={width:"60",height:"60",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1",style:{opacity:".2"}},Am={key:0,class:"canvas-device-frame","aria-hidden":"true"},Tm=["value"],Pm={class:"canvas-guide-label"},Mm={key:5,class:"drop-hint"},Bm={class:"canvas-info-bar"},Nm=["disabled"],zm={class:"slide-index"},Lm=["disabled"],jm={key:0},Dm={__name:"EditorCanvas",setup(x){const d=rt(),r=st(),c=R(null),p=R(null),b=R(1),h=T(()=>b.value*d.zoomLevel);Bl("canvasScale",h);const L=T(()=>r.getProject(d.projectId)),Y=T(()=>_t(L.value)),ie=T(()=>Sl(L.value)),q=T(()=>Y.value.width),j=T(()=>Y.value.height),ve=T(()=>$l(q.value,j.value)),$=T(()=>{var g,w;return(w=(g=L.value)==null?void 0:g.slides)==null?void 0:w.find(K=>K.id===d.currentSlideId)}),P=T(()=>{var g;return[...((g=L.value)==null?void 0:g.slides)||[]].sort((w,K)=>w.order-K.order)}),a=T(()=>P.value.findIndex(g=>g.id===d.currentSlideId)),z=T(()=>{var g;return{autoPlay:!1,motionPresets:[],...((g=L.value)==null?void 0:g.settings)||{}}}),V=T(()=>(Array.isArray(z.value.motionPresets)?z.value.motionPresets:[]).filter(g=>g.scope==="group")),be=T(()=>{const g=new Set(d.selectedElementIds);return se.value.filter(w=>g.has(w.id))}),ce=R(""),oe=T(()=>$.value?$.value.advanceOnMediaEnd?{label:"Media Advance",tone:"media"}:z.value.autoPlay&&Number($.value.duration||0)>0?{label:`Auto ${Number($.value.duration).toFixed(Number($.value.duration)%1===0?0:1)}s`,tone:"auto"}:{label:"Manual",tone:"manual"}:{label:"Manual",tone:"manual"});function m(){const g=V.value.find(K=>K.id===ce.value);if(!g||!be.value.length)return;[...be.value].sort((K,H)=>(K.y||0)!==(H.y||0)?(K.y||0)-(H.y||0):(K.x||0)-(H.x||0)).forEach((K,H)=>{if(g.type==="auto"){r.updateElement(d.projectId,d.currentSlideId,K.id,{animations:[]});return}r.updateElement(d.projectId,d.currentSlideId,K.id,{animations:[{type:g.type,delay:Math.max(0,Number(g.delay)||0)+H*Math.max(0,Number(g.stepDelay)||0),duration:Math.max(.1,Number(g.duration)||.72)}]})}),r.updateProject(d.projectId,{settings:{...z.value,motionPresets:(z.value.motionPresets||[]).map(K=>K.id===g.id?{...K,usageCount:Math.max(0,Number(K.usageCount||0))+1,lastUsedAt:Date.now()}:K)}})}function C(){if(!V.value.length){ce.value="";return}V.value.some(g=>g.id===ce.value)||(ce.value=V.value[0].id)}const se=T(()=>{var g;return[...((g=$.value)==null?void 0:g.elements)||[]].sort((w,K)=>(w.zIndex||0)-(K.zIndex||0))}),U=T(()=>{const g=$.value;return g?g.backgroundType==="gradient"&&g.backgroundGradient?{background:g.backgroundGradient}:g.backgroundType==="image"&&g.backgroundImage?{backgroundImage:`url(${g.backgroundImage})`,backgroundSize:"cover",backgroundPosition:"center"}:{background:g.background||"#fff"}:{background:"#fff"}}),Z=T(()=>`scale(${h.value})`);function pe(){if(!c.value)return;const{clientWidth:g,clientHeight:w}=c.value,K=(g-80)/q.value,H=(w-80)/j.value;b.value=Math.min(K,H,1)}let ne=null;Jt(()=>{pe(),ne=new ResizeObserver(pe),c.value&&ne.observe(c.value),C()}),xl(()=>ne==null?void 0:ne.disconnect()),nt(V,()=>{C()},{deep:!0,immediate:!0}),nt(Y,()=>{pe()},{deep:!0});const le=R({x:0,y:0}),we=R({x:0,y:0}),S=R(!1),D=R(!1),O=R(!1),X=R(null),xe=T(()=>{var g,w;return((g=ie.value)==null?void 0:g.id)==="mobile"?{tone:"mobile",label:"Mobile safe area",style:{inset:"5% 8%",borderRadius:"28px"}}:((w=ie.value)==null?void 0:w.id)==="square"?{tone:"square",label:"Square composition guide",style:{inset:"8%",borderRadius:"24px"}}:null}),je=T(()=>{if(!xe.value)return null;if(xe.value.tone==="mobile"){const K=q.value*.08,H=j.value*.05;return{x:K,y:H,width:q.value-K*2,height:j.value-H*2}}const g=q.value*.08,w=j.value*.08;return{x:g,y:w,width:q.value-g*2,height:j.value-w*2}}),Be=T(()=>{if(!je.value)return[];const g=je.value;return se.value.filter(w=>w.visible!==!1).filter(w=>{const K=Number(w.x||0),H=Number(w.y||0),Pe=K+Number(w.width||0),Ne=H+Number(w.height||0);return K<g.x||H<g.y||Pe>g.x+g.width||Ne>g.y+g.height}).map(w=>w.id)}),Oe=T(()=>d.selectedElementIds.filter(g=>Be.value.includes(g)).length),Ve=T(()=>Be.value.length),re=T(()=>!xe.value||!Ve.value?null:Oe.value?`${Oe.value} selected ${Oe.value===1?"element is":"elements are"} outside the ${xe.value.label.toLowerCase()}.`:`${Ve.value} ${Ve.value===1?"element is":"elements are"} outside the ${xe.value.label.toLowerCase()}.`),de=T(()=>{if(!S.value)return null;const g=Math.min(le.value.x,we.value.x),w=Math.min(le.value.y,we.value.y),K=Math.abs(we.value.x-le.value.x),H=Math.abs(we.value.y-le.value.y);return{x:g,y:w,width:K,height:H}});function Ee(g){!S.value&&(g.target===p.value||g.target===g.currentTarget)&&d.clearSelection()}function ge(g){return g?Array.from(g.files||[]).some(w=>w.type.startsWith("image/")):!1}function J(g){return g?Array.from(g.types||[]).includes(Qt):!1}function M(g,w,K){return Math.min(Math.max(g,w),K)}function A(g,w,K){const H=Xt(g),Pe=M(w-H.width/2,0,Math.max(0,q.value-H.width)),Ne=M(K-H.height/2,0,Math.max(0,j.value-H.height));return{x:Pe,y:Ne,bounds:H}}function _(g){if(!J(g))return null;try{const w=g.getData(Qt),K=w?JSON.parse(w):null;return K!=null&&K.id&&r.getContentBlocks(d.projectId).find(H=>H.id===K.id)||null}catch{return null}}function Ie(g,w,K){if(!p.value||!K){X.value=null;return}const H=p.value.getBoundingClientRect(),Pe=(g-H.left)/h.value,Ne=(w-H.top)/h.value,Ge=A(K,Pe,Ne);X.value={block:K,x:Ge.x,y:Ge.y,bounds:Ge.bounds}}function Ae(g,w,K){if(!g||!g.type.startsWith("image/"))return;const H=new FileReader;H.onload=()=>{const Pe=String(H.result||"");if(!Pe)return;const Ne=new Image;Ne.onload=()=>{const Ge=p.value.getBoundingClientRect(),Je=(w-Ge.left)/h.value,ue=(K-Ge.top)/h.value,We=Math.min(420/Ne.width,280/Ne.height,1),De=Math.max(120,Math.round(Ne.width*We)),Qe=Math.max(80,Math.round(Ne.height*We)),yt=Math.max(0,Math.min(q.value-De,Math.round(Je-De/2))),gt=Math.max(0,Math.min(j.value-Qe,Math.round(ue-Qe/2))),kt=r.addElement(d.projectId,d.currentSlideId,"image",{x:yt,y:gt,width:De,height:Qe,content:{src:Pe,alt:g.name,objectFit:"cover"}});kt&&(d.selectElement(kt.id),d.setActiveTool("select"),d.setRightPanel("properties"))},Ne.src=Pe},H.readAsDataURL(g)}function Fe(g){const w=ge(g.dataTransfer),K=J(g.dataTransfer);!w&&!K||(g.preventDefault(),g.dataTransfer.dropEffect="copy",D.value=w,O.value=K,K&&Ie(g.clientX,g.clientY,_(g.dataTransfer)))}function y(g){var w;(w=g.currentTarget)!=null&&w.contains(g.relatedTarget)||(D.value=!1,O.value=!1,X.value=null)}function $e(g){const w=ge(g.dataTransfer),K=J(g.dataTransfer);if(!w&&!K)return;if(g.preventDefault(),D.value=!1,O.value=!1,X.value=null,K){try{const Pe=_(g.dataTransfer);if(!Pe)return;const Ne=p.value.getBoundingClientRect(),Ge=(g.clientX-Ne.left)/h.value,Je=(g.clientY-Ne.top)/h.value,ue=A(Pe,Ge,Je),Te=r.insertContentBlock(d.projectId,d.currentSlideId,Pe.id,{x:ue.x,y:ue.y});Te.length&&(d.setSelection(Te.map(lt=>lt.id)),d.setActiveTool("select"),d.focusPropertiesSection("content"))}catch(Pe){console.warn("Failed to drop block onto canvas.",Pe)}return}const H=Array.from(g.dataTransfer.files||[]).find(Pe=>Pe.type.startsWith("image/"));H&&Ae(H,g.clientX,g.clientY)}function He(g){if(be.value.length<2)return;const w=[...be.value].sort((ue,Te)=>(ue.zIndex||0)-(Te.zIndex||0)),K=Math.min(...w.map(ue=>Number(ue.x||0))),H=Math.min(...w.map(ue=>Number(ue.y||0))),Pe=Math.max(...w.map(ue=>Number(ue.x||0)+Number(ue.width||0))),Ne=Math.max(...w.map(ue=>Number(ue.y||0)+Number(ue.height||0))),Ge=K+(Pe-K)/2,Je=H+(Ne-H)/2;if(g==="align-left"&&w.forEach(ue=>r.updateElement(d.projectId,d.currentSlideId,ue.id,{x:K},{persist:!1})),g==="align-center"&&w.forEach(ue=>{const Te=Number(ue.width||0);r.updateElement(d.projectId,d.currentSlideId,ue.id,{x:Ge-Te/2},{persist:!1})}),g==="align-right"&&w.forEach(ue=>{const Te=Number(ue.width||0);r.updateElement(d.projectId,d.currentSlideId,ue.id,{x:Pe-Te},{persist:!1})}),g==="align-top"&&w.forEach(ue=>r.updateElement(d.projectId,d.currentSlideId,ue.id,{y:H},{persist:!1})),g==="align-middle"&&w.forEach(ue=>{const Te=Number(ue.height||0);r.updateElement(d.projectId,d.currentSlideId,ue.id,{y:Je-Te/2},{persist:!1})}),g==="align-bottom"&&w.forEach(ue=>{const Te=Number(ue.height||0);r.updateElement(d.projectId,d.currentSlideId,ue.id,{y:Ne-Te},{persist:!1})}),g==="distribute-horizontal"){const ue=[...w].sort((De,Qe)=>(De.x||0)-(Qe.x||0)),Te=ue.reduce((De,Qe)=>De+Number(Qe.width||0),0),lt=ue.length>1?(Pe-K-Te)/(ue.length-1):0;let We=K;ue.forEach(De=>{r.updateElement(d.projectId,d.currentSlideId,De.id,{x:We},{persist:!1}),We+=Number(De.width||0)+lt})}if(g==="distribute-vertical"){const ue=[...w].sort((De,Qe)=>(De.y||0)-(Qe.y||0)),Te=ue.reduce((De,Qe)=>De+Number(Qe.height||0),0),lt=ue.length>1?(Ne-H-Te)/(ue.length-1):0;let We=H;ue.forEach(De=>{r.updateElement(d.projectId,d.currentSlideId,De.id,{y:We},{persist:!1}),We+=Number(De.height||0)+lt})}r.commitProject(d.projectId)}function Ue(g){const w=d.activeTool;if(g.target!==p.value&&g.target!==g.currentTarget)return;g.preventDefault(),g.stopPropagation();const K=p.value.getBoundingClientRect(),H=(g.clientX-K.left)/h.value,Pe=(g.clientY-K.top)/h.value;if(w==="select"){S.value=!0,le.value={x:H,y:Pe},we.value={x:H,y:Pe};const Je=Te=>{we.value={x:(Te.clientX-K.left)/h.value,y:(Te.clientY-K.top)/h.value}},ue=()=>{window.removeEventListener("mousemove",Je),window.removeEventListener("mouseup",ue);const Te=de.value;if(Te&&(Te.width>2||Te.height>2)){const lt=se.value.filter(We=>{const De=We.x,Qe=We.y,yt=We.width||100,gt=We.height||100;return De<Te.x+Te.width&&De+yt>Te.x&&Qe<Te.y+Te.height&&Qe+gt>Te.y}).map(We=>We.id);lt.length>0?d.setSelection(lt):d.clearSelection()}else d.clearSelection();setTimeout(()=>{S.value=!1},0)};window.addEventListener("mousemove",Je),window.addEventListener("mouseup",ue);return}const Ne=Je=>d.snapToGrid?Math.round(Je/d.gridSize)*d.gridSize:Je,Ge=r.addElement(d.projectId,d.currentSlideId,w,{x:Ne(H-75),y:Ne(Pe-40)});Ge&&(d.selectElement(Ge.id),d.setActiveTool("select"),d.setRightPanel("properties"))}const Xe=T(()=>{if(!d.showGrid)return{};const g=d.gridSize;return{backgroundImage:`
    ...
    `,backgroundSize:`${g}px ${g}px`}}),Ye={text:Yt,heading:Yt,image:Uf,shape:Qf,button:Xf,hotspot:tm,video:sm,audio:pm,quiz:wm,chart:ai,tabs:ii,accordion:li,flipcard:ni,stepper:oi,poll:ti,labeledimage:ei,matching:Zl,sorting:Kl,cloze:Jl,scenario:Xl,progress:Ql,placeholder:$m,divider:"div"};function Tt(g){return Ye[g]||Yt}function ct(g){var w,K;return g.type!=="divider"?{}:{borderTop:`${((w=g.content)==null?void 0:w.thickness)||2}px solid ${((K=g.content)==null?void 0:K.color)||"#e2e8f0"}`,width:"100%",height:"100%"}}const _e=R({show:!1,x:0,y:0,elId:null});function ft(g,w){g.preventDefault(),_e.value={show:!0,x:g.clientX,y:g.clientY,elId:w},d.selectElement(w),setTimeout(()=>window.addEventListener("click",et,{once:!0}),0)}function et(){_e.value.show=!1}function At(){if(_e.value.elId){const g=r.duplicateElement(d.projectId,d.currentSlideId,_e.value.elId);g&&d.selectElement(g.id)}et()}function Pt(){_e.value.elId&&(r.deleteElement(d.projectId,d.currentSlideId,_e.value.elId),d.clearSelection()),et()}function Mt(){_e.value.elId&&r.reorderElement(d.projectId,d.currentSlideId,_e.value.elId,"up"),et()}function Bt(){_e.value.elId&&r.reorderElement(d.projectId,d.currentSlideId,_e.value.elId,"down"),et()}function Nt(){const g=a.value,w=r.addSlide(d.projectId,g);w&&d.setCurrentSlide(w.id)}function zt(){const g=a.value;g>0&&d.setCurrentSlide(P.value[g-1].id)}function mt(){const g=a.value;g<P.value.length-1&&d.setCurrentSlide(P.value[g+1].id)}return(g,w)=>{var K;return l(),i("div",{class:"canvas-container",ref_key:"canvasContainerRef",ref:c},[$.value?(l(),i(te,{key:1},[e("div",{class:W(["canvas-zoom-wrapper",[xe.value&&`canvas-zoom-wrapper-${xe.value.tone}`]]),style:ye({transform:Z.value,transformOrigin:"center center",transition:"transform .15s ease"})},[e("div",{ref_key:"canvasRef",ref:p,class:"slide-canvas",style:ye({width:q.value+"px",height:j.value+"px",...U.value,...Xe.value}),onClick:Ee,onMousedown:Ue,onDragover:Fe,onDragleave:y,onDrop:$e,onContextmenu:w[3]||(w[3]=Le(()=>{},["prevent"]))},[xe.value?(l(),i("div",Am)):F("",!0),E(d).multiSelection&&V.value.length?(l(),i("div",{key:1,class:"selection-preset-chip",onMousedown:w[1]||(w[1]=Le(()=>{},["stop"]))},[w[15]||(w[15]=e("span",{class:"selection-preset-label"},"Sequence",-1)),me(e("select",{"onUpdate:modelValue":w[0]||(w[0]=H=>ce.value=H),class:"selection-preset-select"},[(l(!0),i(te,null,fe(V.value,H=>(l(),i("option",{key:H.id,value:H.id},k(H.name),9,Tm))),128))],512),[[jt,ce.value]]),e("button",{type:"button",class:"selection-preset-apply",onClick:Le(m,["stop"])},"Apply")],32)):F("",!0),re.value?(l(),i("div",{key:2,class:"canvas-guide-warning",onMousedown:w[2]||(w[2]=Le(()=>{},["stop"]))},[w[16]||(w[16]=e("span",{class:"canvas-guide-warning-dot"},null,-1)),e("span",null,k(re.value),1)],32)):F("",!0),X.value?(l(),i("div",{key:3,class:"block-drop-preview",style:ye({left:`${X.value.x}px`,top:`${X.value.y}px`,width:`${X.value.bounds.width}px`,height:`${X.value.bounds.height}px`})},[(l(!0),i(te,null,fe(X.value.block.elements,(H,Pe)=>{var Ne,Ge,Je,ue;return l(),i("div",{key:`${X.value.block.id}-preview-${Pe}`,class:W(["block-drop-preview-el",`block-drop-preview-${H.type}`]),style:ye({left:`${Number(H.x||0)-X.value.bounds.minX}px`,top:`${Number(H.y||0)-X.value.bounds.minY}px`,width:`${Number(H.width||0)}px`,height:`${Number(H.height||0)}px`,borderRadius:H.type==="shape"&&((Ne=H.content)==null?void 0:Ne.shapeType)==="circle"?"50%":`${Number(((Ge=H.content)==null?void 0:Ge.borderRadius)||12)}px`,background:H.type==="shape"?((Je=H.content)==null?void 0:Je.fillColor)||"rgba(108,71,255,.18)":H.type==="button"?((ue=H.content)==null?void 0:ue.bgColor)||"rgba(108,71,255,.32)":["text","heading"].includes(H.type)?"transparent":"rgba(148,163,184,.18)"})},[["text","heading"].includes(H.type)?(l(),i(te,{key:0},[w[17]||(w[17]=e("span",{class:"block-drop-preview-line"},null,-1)),w[18]||(w[18]=e("span",{class:"block-drop-preview-line short"},null,-1))],64)):F("",!0)],6)}),128))],4)):F("",!0),(l(!0),i(te,null,fe(se.value,H=>(l(),ot(_f,{key:H.id,element:H,onContextmenu:Le(Pe=>ft(Pe,H.id),["stop"])},{default:vt(()=>[(l(),ot(Ml(Tt(H.type)),{element:H,style:ye(H.type==="divider"?ct(H):{})},null,8,["element","style"]))]),_:2},1032,["element","onContextmenu"]))),128)),xe.value?(l(),i("div",{key:4,class:W(["canvas-guide",[`canvas-guide-${xe.value.tone}`,Ve.value&&"canvas-guide-warning-state"]]),style:ye(xe.value.style),"aria-hidden":"true"},[e("span",Pm,k(xe.value.label)+" · "+k(ve.value),1)],6)):F("",!0),E(d).activeTool!=="select"||D.value||O.value?(l(),i("div",Mm,k(O.value?"Drop block to insert it here":D.value?"Drop image to insert it on this slide":`Click anywhere to add ${E(d).activeTool}`),1)):F("",!0),S.value&&de.value?(l(),i("div",{key:6,class:"selection-marquee",style:ye({left:de.value.x+"px",top:de.value.y+"px",width:de.value.width+"px",height:de.value.height+"px"})},null,4)):F("",!0)],36)],6),e("div",Bm,[e("button",{class:"bar-btn",onClick:Nt},"Add page"),e("button",{class:"bar-btn icon",onClick:zt,disabled:a.value<=0},"◀",8,Nm),e("span",zm,k(a.value+1)+" / "+k(P.value.length),1),e("button",{class:"bar-btn icon",onClick:mt,disabled:a.value>=P.value.length-1},"▶",8,Lm),e("span",null,k(q.value)+" × "+k(j.value)+"px",1),w[19]||(w[19]=e("span",null,"·",-1)),e("span",null,k(((K=$.value.elements)==null?void 0:K.length)||0)+" elements",1),w[20]||(w[20]=e("span",null,"·",-1)),e("span",{class:W(["playback-badge",`playback-badge-${oe.value.tone}`])},k(oe.value.label),3),E(d).hasSelection?(l(),i("span",jm,"· "+k(E(d).selectedElementIds.length)+" selected",1)):F("",!0),E(d).multiSelection?(l(),i(te,{key:1},[e("button",{class:"bar-btn",onClick:w[4]||(w[4]=H=>He("align-left"))},"Left"),e("button",{class:"bar-btn",onClick:w[5]||(w[5]=H=>He("align-center"))},"Center"),e("button",{class:"bar-btn",onClick:w[6]||(w[6]=H=>He("align-right"))},"Right"),e("button",{class:"bar-btn",onClick:w[7]||(w[7]=H=>He("align-top"))},"Top"),e("button",{class:"bar-btn",onClick:w[8]||(w[8]=H=>He("align-middle"))},"Middle"),e("button",{class:"bar-btn",onClick:w[9]||(w[9]=H=>He("align-bottom"))},"Bottom"),e("button",{class:"bar-btn",onClick:w[10]||(w[10]=H=>He("distribute-horizontal"))},"Space H"),e("button",{class:"bar-btn",onClick:w[11]||(w[11]=H=>He("distribute-vertical"))},"Space V")],64)):F("",!0),e("button",{class:"bar-btn ai",onClick:w[12]||(w[12]=H=>E(d).setRightPanel("ai"))},"AI")])],64)):(l(),i("div",Im,[(l(),i("svg",Em,[...w[13]||(w[13]=[e("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"},null,-1)])])),w[14]||(w[14]=e("p",null,"Select a slide to start editing",-1))])),(l(),ot(wl,{to:"body"},[_e.value.show?(l(),i("div",{key:0,class:"ctx-menu",style:ye({left:_e.value.x+"px",top:_e.value.y+"px"})},[e("button",{class:"ctx-item",onClick:At},"Duplicate"),e("button",{class:"ctx-item",onClick:Mt},"Bring Forward"),e("button",{class:"ctx-item",onClick:Bt},"Send Backward"),w[21]||(w[21]=e("div",{class:"ctx-divider"},null,-1)),e("button",{class:"ctx-item danger",onClick:Pt},"Delete")],4)):F("",!0)]))],512)}}},Rm=Ze(Dm,[["__scopeId","data-v-c34e22ca"]]),_m={class:"ai-panel"},qm={class:"ai-mode-tabs"},Om=["onClick"],Fm={class:"ai-content"},Vm={class:"form-group"},Hm={class:"output-mode-switch",role:"group","aria-label":"Slide generation scope"},Um={key:0,class:"form-group"},Wm={key:1,class:"form-group"},Gm={class:"layout-label-row"},Ym={class:"layout-current-hint"},Qm={class:"layout-preset-grid",role:"group","aria-label":"AI layout preset"},Xm=["onClick"],Jm={class:"layout-preset-title"},Km={class:"layout-preset-hint"},Zm={key:2,class:"form-group"},e1={key:3,class:"form-group"},t1={class:"layout-label-row"},o1={class:"layout-current-hint"},n1={class:"output-mode-switch",role:"group","aria-label":"Deck layout strategy"},l1={key:4,class:"form-group"},i1={class:"layout-label-row"},a1={class:"layout-current-hint"},r1={class:"layout-preset-grid",role:"group","aria-label":"Deck layout preset"},s1=["onClick"],d1={class:"layout-preset-title"},u1={class:"layout-preset-hint"},c1={class:"form-group"},p1={class:"form-group"},v1={class:"prompt-label-row"},f1={key:1,class:"prompt-auto-badge"},m1={key:5,class:"output-mode-switch",role:"group","aria-label":"Generation output mode"},g1={key:6,class:"selected-source-card"},b1={class:"result-header"},h1={class:"source-count-badge"},y1={class:"selected-source-preview"},x1={class:"selected-source-actions"},w1=["disabled"],k1=["disabled"],C1={key:0,class:"spinner"},S1={key:1,width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},$1={key:7,class:"creative-options-wrap"},I1={class:"result-header"},E1={key:0,class:"ai-error",style:{"margin-top":"var(--space-2)"}},A1={key:1,class:"creative-options-list"},T1={class:"creative-title"},P1={class:"creative-angle"},M1=["onClick"],B1={class:"form-group"},N1={class:"quiz-config-row"},z1={class:"form-group",style:{flex:"1"}},L1={class:"form-group",style:{flex:"1"}},j1={class:"form-group"},D1={class:"qtype-btns"},R1=["onClick"],_1={class:"qtype-icon"},q1={class:"form-group"},O1={class:"form-group"},F1={class:"prompt-label-row"},V1={key:1,class:"prompt-auto-badge"},H1=["disabled"],U1={key:0,class:"spinner"},W1={key:1,width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},G1={key:0,class:"quiz-results"},Y1={class:"quiz-results-header"},Q1={class:"form-label"},X1={class:"quiz-header-actions"},J1={class:"regen-row"},K1=["disabled"],Z1={key:0,class:"spinner spinner-sm"},eg={key:1,width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.5"},tg=["disabled"],og={class:"quiz-card-header"},ng={class:"quiz-card-check"},lg=["onUpdate:modelValue"],ig={class:"q-num"},ag={class:"q-badges"},rg={class:"badge type-badge"},sg={class:"q-question"},dg={class:"q-options"},ug={class:"q-option-letter"},cg={key:0,class:"q-check-icon",width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.5"},pg={key:0,class:"q-explanation"},vg=["disabled"],fg={class:"form-group",style:{"margin-bottom":"var(--space-3)"}},mg=["disabled"],gg={key:0,class:"spinner"},bg={key:0,class:"selected-text-preview"},hg={class:"text-preview"},yg={key:1,class:"ai-hint"},xg={class:"form-group",style:{"margin-bottom":"var(--space-3)","margin-top":"var(--space-3)"}},wg=["disabled"],kg={key:0,class:"spinner"},Cg={key:0,class:"selected-text-preview"},Sg={class:"text-preview"},$g={key:1,class:"ai-hint"},Ig={class:"form-group",style:{"margin-top":"var(--space-3)","margin-bottom":"var(--space-3)"}},Eg=["disabled"],Ag={key:0,class:"spinner"},Tg={key:2,class:"improve-result-wrap",style:{"margin-top":"var(--space-4)"}},Pg={class:"result-header"},Mg={class:"result-actions"},Bg=["disabled"],Ng={class:"textarea result-display"},zg={key:0,class:"demo-notice",style:{"margin-bottom":"var(--space-3)"}},Lg={key:1,class:"ai-error",style:{"margin-bottom":"var(--space-3)"}},jg={class:"form-group",style:{"margin-bottom":"var(--space-3)"}},Dg=["disabled"],Rg={key:0,class:"spinner"},_g={key:2,class:"improve-result-wrap",style:{"margin-top":"var(--space-4)"}},qg={class:"textarea result-display",style:{color:"var(--color-primary)"}},Og={key:6,class:"ai-settings"},Fg={class:"form-group",style:{"margin-bottom":"var(--space-4)"}},Vg=["value"],Hg={class:"form-group",style:{"margin-bottom":"var(--space-4)"}},Ug=["value","placeholder"],Wg={class:"form-hint"},Gg={key:0,class:"demo-notice"},Yg={key:1,class:"demo-notice"},Qg={key:7,class:"result-area"},Xg={class:"result-header"},Jg={class:"result-pre"},Kg={class:"result-actions"},Zg=["disabled"],eb={key:8,class:"ai-error"},tb={__name:"AIAssistant",setup(x){const d=[{id:"classic",label:"Classic",hint:"Title, bullets, and a takeaway.",promptHint:"Use a standard explanatory slide with a title, optional subtitle, 3-5 bullets, and one strong takeaway.",schema:'{ "layout": "classic", "title": "...", "subtitle": "...", "bullets": ["..."], "callout": "..." }'},{id:"cards",label:"Cards",hint:"Three concept or benefit cards.",promptHint:"Structure the content as three distinct cards with a short title and supporting sentence for each.",schema:'{ "layout": "cards", "title": "...", "subtitle": "...", "callout": "...", "cards": [{ "title": "...", "body": "..." }, { "title": "...", "body": "..." }, { "title": "...", "body": "..." }] }'},{id:"comparison",label:"Comparison",hint:"Side-by-side before/after or option A/B.",promptHint:"Create a two-column comparison with clear labels and 2-3 points on each side.",schema:'{ "layout": "comparison", "title": "...", "subtitle": "...", "callout": "...", "comparison": { "leftTitle": "...", "leftPoints": ["..."], "rightTitle": "...", "rightPoints": ["..."] } }'},{id:"metrics",label:"Metrics",hint:"Three KPI-style highlights.",promptHint:"Return three concise, presentation-ready metrics with realistic values and short labels.",schema:'{ "layout": "metrics", "title": "...", "subtitle": "...", "callout": "...", "metrics": [{ "value": "92%", "label": "..." }, { "value": "3.4x", "label": "..." }, { "value": "14d", "label": "..." }] }'},{id:"timeline",label:"Timeline",hint:"Four-step milestone story.",promptHint:"Turn the topic into four clear milestones that progress from start to finish.",schema:'{ "layout": "timeline", "title": "...", "subtitle": "...", "callout": "...", "timeline": [{ "title": "...", "detail": "..." }, { "title": "...", "detail": "..." }, { "title": "...", "detail": "..." }, { "title": "...", "detail": "..." }] }'},{id:"faq",label:"FAQ",hint:"Three audience questions and answers.",promptHint:"Return three strong audience questions, each with a concise useful answer.",schema:'{ "layout": "faq", "title": "...", "subtitle": "...", "callout": "...", "faqs": [{ "question": "...", "answer": "..." }, { "question": "...", "answer": "..." }, { "question": "...", "answer": "..." }] }'},{id:"process",label:"Process",hint:"Three practical steps.",promptHint:"Break the topic into three clear steps with actionable descriptions.",schema:'{ "layout": "process", "title": "...", "subtitle": "...", "callout": "...", "process": [{ "title": "...", "detail": "..." }, { "title": "...", "detail": "..." }, { "title": "...", "detail": "..." }] }'},{id:"cloze",label:"Fill-in-the-Blank",hint:"Interactive fill-in-the-blank text.",promptHint:"Create an interactive fill-in-the-blank activity. Provide a paragraph with a few key words wrapped in [brackets] to indicate blanks.",schema:'{ "layout": "cloze", "title": "...", "subtitle": "...", "callout": "...", "cloze": { "text": "A sentence about the topic where the [key word] is in brackets." } }'},{id:"scenario",label:"Scenario",hint:"Branching scenario with choices.",promptHint:"Create a branching scenario. Provide a starting situation from the agent, and 2-3 potential responses from the user.",schema:'{ "layout": "scenario", "title": "...", "subtitle": "...", "callout": "...", "scenario": { "agentMessage": "...", "userOptions": ["..."] } }'},{id:"progress",label:"Progress",hint:"A step-by-step progress indicator.",promptHint:"Create a progress overview representing the users current learning status. Provide realistic mock values.",schema:'{ "layout": "progress", "title": "...", "subtitle": "...", "callout": "...", "progress": { "level": 4, "xp": 350, "percent": 65 } }'},{id:"poll",label:"Poll",hint:"An interactive poll or survey.",promptHint:"Create an interactive poll question with 3-4 options. Provide realistic mock vote counts.",schema:'{ "layout": "poll", "title": "...", "subtitle": "...", "callout": "...", "poll": { "question": "...", "options": [{ "text": "...", "votes": 12 }] } }'},{id:"matching",label:"Matching",hint:"A drag-and-drop matching activity.",promptHint:"Create a matching activity with 3-4 pairs of related concepts (e.g. term and definition).",schema:'{ "layout": "matching", "title": "...", "subtitle": "...", "callout": "...", "matching": { "pairs": [{ "left": "...", "right": "..." }] } }'},{id:"sorting",label:"Sorting",hint:"A sorting activity.",promptHint:"Create an activity where items need to be sorted into correct order. Provide the items in random order.",schema:'{ "layout": "sorting", "title": "...", "subtitle": "...", "callout": "...", "sorting": { "items": [{ "text": "...", "correctOrder": 0 }] } }'},{id:"labeledimage",label:"Labeled Image",hint:"An image with interactive hotspots.",promptHint:"Define 2-3 standard hotspots (x, y percentages) with labels and descriptions over a concept.",schema:'{ "layout": "labeledimage", "title": "...", "subtitle": "...", "callout": "...", "labeledimage": { "markers": [{ "x": 25, "y": 35, "label": "1", "title": "...", "description": "..." }] } }'}],r={cards:"three-card-grid",comparison:"comparison-columns",metrics:"metric-strip",timeline:"timeline-ribbon",faq:"faq-stack",process:"process-ladder"};function c(s,n="classic"){const v=String(s||n||"classic").trim().toLowerCase();return d.some(I=>I.id===v)?v:n}function p(s,n=""){return String(s??n).replace(/^\s*[-•]\s*/,"").trim()||n}function b(s){return(Array.isArray(s)?s:typeof s=="string"?s.split(`
`):[]).map(v=>p(v)).filter(Boolean)}function h(s,n,v){const I=[...s];for(;I.length<n;)I.push(v(I.length));return I.slice(0,n)}function L(s,n){const v=Array.isArray(s)?s.map((f,G)=>({title:p(f==null?void 0:f.title,`Card ${G+1}`),body:p((f==null?void 0:f.body)||(f==null?void 0:f.text)||(f==null?void 0:f.description),"Add supporting detail.")})).filter(f=>f.title||f.body):[],I=n.map((f,G)=>({title:`Point ${G+1}`,body:f}));return h(v.length?v:I,3,f=>({title:`Point ${f+1}`,body:"Add supporting detail."}))}function Y(s,n){const v=b(s==null?void 0:s.leftPoints),I=b(s==null?void 0:s.rightPoints),f=n.slice(0,Math.max(1,Math.ceil(n.length/2))),G=n.slice(Math.max(1,Math.ceil(n.length/2)));return{leftTitle:p(s==null?void 0:s.leftTitle,"Option A"),leftPoints:h(v.length?v:f,3,he=>`Left point ${he+1}`),rightTitle:p(s==null?void 0:s.rightTitle,"Option B"),rightPoints:h(I.length?I:G,3,he=>`Right point ${he+1}`)}}function ie(s,n){const v=Array.isArray(s)?s.map((f,G)=>({value:p(f==null?void 0:f.value,`${G+1}`),label:p(f==null?void 0:f.label,`Metric ${G+1}`)})).filter(f=>f.value||f.label):[],I=n.map((f,G)=>{const[he,...tt]=f.split(/[:\-]/);return{value:p(he,`${G+1}`),label:p(tt.join(" ").trim(),f)}});return h(v.length?v:I,3,f=>({value:`${f+1}`,label:`Metric ${f+1}`}))}function q(s,n){const v=Array.isArray(s)?s.map((f,G)=>({title:p(f==null?void 0:f.title,`Phase ${G+1}`),detail:p((f==null?void 0:f.detail)||(f==null?void 0:f.description),"Explain the milestone.")})).filter(f=>f.title||f.detail):[],I=n.map((f,G)=>({title:`Phase ${G+1}`,detail:f}));return h(v.length?v:I,4,f=>({title:`Phase ${f+1}`,detail:"Explain the milestone."}))}function j(s,n){const v=Array.isArray(s)?s.map((f,G)=>({question:p(f==null?void 0:f.question,`Question ${G+1}?`),answer:p(f==null?void 0:f.answer,"Add the short answer here.")})).filter(f=>f.question||f.answer):[],I=n.map((f,G)=>({question:`Question ${G+1}?`,answer:f}));return h(v.length?v:I,3,f=>({question:`Question ${f+1}?`,answer:"Add the short answer here."}))}function ve(s,n){const v=Array.isArray(s)?s.map((f,G)=>({title:p(f==null?void 0:f.title,`Step ${G+1}`),detail:p((f==null?void 0:f.detail)||(f==null?void 0:f.description),"Add the step detail here.")})).filter(f=>f.title||f.detail):[],I=n.map((f,G)=>({title:`Step ${G+1}`,detail:f}));return h(v.length?v:I,3,f=>({title:`Step ${f+1}`,detail:"Add the step detail here."}))}const $=Ll(),P=rt(),a=st(),z=T(()=>$.apiProvider==="gemini"?"Gemini":"OpenAI"),V=T(()=>$.apiProvider==="gemini"?"AIza...":"sk-..."),be=T(()=>$.apiProvider==="gemini"?"Gemini API keys from Google AI Studio work for text features on the free tier. We provide free image generation via Pollinations.ai when Gemini is selected. The key is stored locally in your browser and never sent to our servers.":"Key is stored locally in your browser. It is never sent to our servers."),ce=R("generate"),oe=R(""),m=R(""),C=R("");nt(ce,()=>{C.value=""}),nt(()=>P.aiPanelMode,s=>{s&&(ce.value=s)},{immediate:!0});const se=R(4),U=R("general"),Z=R("Spanish"),pe=R(""),ne=R(""),le=R(""),we=R(!1),S=R("single"),D=R("classic"),O=R("mixed"),X=R(5),xe=R("slide"),je=R([]),Be=R(""),Oe=T(()=>d.find(s=>s.id===D.value)||d[0]),Ve=T(()=>{const s=m.value.trim()||"[your topic]";if(S.value==="deck"){let I=`Create a complete ${X.value}-slide learning deck about "${s}".`;return ne.value.trim()&&(I+=`
...
.motion-fade-up { animation-name: motion-fade-up; }
.motion-fade-up-strong { animation-name: motion-fade-up-strong; }
.motion-fade-left { animation-name: motion-fade-left; }
.motion-fade-right { animation-name: motion-fade-right; }
.motion-zoom-in { animation-name: motion-zoom-in; }
.motion-soft-pop, .motion-pop-in { animation-name: motion-pop-in; }
.motion-stagger-in { animation-name: motion-stagger-in; }
...
@keyframes motion-fade-left {
  from { opacity: 0; transform: translateX(-26px); filter: blur(8px); }
...
${$()}
  ...
  function elementMotionPreset(el) {
    if (!el) return 'fade-up';
    var customAnimation = Array.isArray(el.animations) ? el.animations[0] : null;
    var customType = customAnimation && (customAnimation.type || customAnimation.name);
    if (customType) return customType.toString().toLowerCase().replace(/s+/g, '-');
    switch (el.type) {
  ...
  function buildElementBox(el, interactive, index) {
    var node = document.createElement('div');
    var motionPreset = elementMotionPreset(el);
    node.className = 'lf-el lf-el-' + (el.type || 'unknown') + ' motion-' + motionPreset + ' preview-element';
    ...
    var customAnimation = Array.isArray(el.animations) ? el.animations[0] : null;
    var customDelay = customAnimation && customAnimation.delay != null ? Math.max(0, Number(customAnimation.delay) || 0) * 1000 : 0;
    var staggerDelay = motionPreset === 'stagger-in' ? (index || 0) * 140 : Math.min((index || 0) * 90, 720);
    var delay = customAnimation && customAnimation.delay != null ? customDelay + (motionPreset === 'stagger-in' ? (index || 0) * 140 : 0) : staggerDelay;
    var duration = customAnimation && customAnimation.duration != null ? Math.max(100, Number(customAnimation.duration) * 1000 || 640) : (motionPreset === 'stagger-in' ? 720 : el.type === 'heading' ? 720 : el.type === 'image' ? 780 : 640);
    
    node.style.setProperty('--enter-delay', delay + 'ms');
    node.style.setProperty('--enter-duration', duration + 'ms');
  ...
  function renderSlide(slide, slideIndex) {
    ...
    elements.forEach(function (el, idx) {
      if (el && el.visible !== false) {
        node.appendChild(renderElement(el, idx));
      }
    });
  ...
  function renderElement(el, index) {
    ...
    var wrapper = buildElementBox(el, interactive, index);
...
`}async function a(){return ce("html")}async function z(){return ce("iframe")}async function V(){return ce("scorm")}async function be(){return ce("pdf")}async function ce(oe="html"){var re,de,Ee;const m=p.value;if(!m)return;h.value="processing";const C=oe==="pdf"&&typeof window<"u"?window.open("","_blank"):null;if(oe==="pdf"&&!C){h.value="error",setTimeout(()=>h.value="",3e3);return}const se=oe==="pdf"?null:new ri,U=se?se.folder("assets"):null;let Z=0;async function pe(ge,J="media"){if((!ge||ge.startsWith("data:")||ge.startsWith("http://localhost")||ge.startsWith("blob:"))&&ge.startsWith("data:"))return ge;try{const A=await(await fetch(ge)).blob();if(oe==="pdf")return await j(A);let _="bin";const Ie=A.type;if(Ie.includes("image/png")?_="png":Ie.includes("image/jpeg")?_="jpg":Ie.includes("image/gif")?_="gif":Ie.includes("image/svg")?_="svg":Ie.includes("image/webp")?_="webp":Ie.includes("video/mp4")?_="mp4":Ie.includes("audio/mpeg")&&(_="mp3"),_==="bin"){const Fe=ge.match(/\\.([a-zA-Z0-9]+)(\\?.*)?$/);Fe&&(_=Fe[1])}Z++;const Ae=`${J}_${Z}.${_}`;return U.file(Ae,A),`assets/${Ae}`}catch(M){return console.warn("Could not fetch asset:",ge,M),ge}}const ne=JSON.parse(JSON.stringify([...m.slides||[]])).sort((ge,J)=>(ge.order??0)-(J.order??0));if(Y.value)for(const ge of ne){ge.backgroundType==="image"&&ge.backgroundImage&&(ge.backgroundImage=await pe(ge.backgroundImage,"bg"));for(const J of ge.elements||[])J.type==="image"&&((re=J.content)!=null&&re.src)&&(J.content.src=await pe(J.content.src,"img")),J.type==="video"&&((de=J.content)!=null&&de.src)&&!J.content.src.includes("youtube")&&!J.content.src.includes("youtu.be")&&(J.content.src=await pe(J.content.src,"vid")),J.type==="audio"&&((Ee=J.content)!=null&&Ee.src)&&(J.content.src=await pe(J.content.src,"aud"))}const le=q(L.value||m.name||"presentation"),we={name:m.name,theme:m.theme||{},settings:m.settings||{},slides:ne},S=JSON.stringify(we).replace(/</g,"\\u003c").replace(/>/g,"\\u003e").replace(/&/g,"\\u0026"),D=ve(m.theme,m.settings,oe),O=P(oe),X=`<script id="lf-data" type="application/json">${S}<\/script>`,je=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
</html>`;if(oe==="pdf"){C.document.open(),C.document.write(je),C.document.close(),h.value="success",setTimeout(()=>h.value="",3e3);return}if(oe==="scorm"){const ge=(le||"SCORM Export").replace(/[&<>'"]/g,""),J=`<?xml version="1.0" standalone="no" ?>
