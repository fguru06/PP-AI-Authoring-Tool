...
Make all content specific to "${r}" — no generic placeholders.`,v});Qe(ee,r=>{ke.value||(te.value=r)},{immediate:!0});function ve(){te.value=ee.value,ke.value=!1}const ie=z(""),fe=z("intermediate"),Me=z("multiple-choice"),he=z(""),S=z([]),$=z(""),q=z(!1),x=P(()=>{const r=ie.value.trim()||"[your topic]",o={beginner:"Beginner",intermediate:"Intermediate",advanced:"Advanced"},v={"multiple-choice":"Multiple Choice","true-false":"True / False",mixed:"Mixed (MCQ + T/F)"};let E=`Generate ${we.value} ${o[fe.value]} ${v[Me.value]} quiz questions about "${r}".
