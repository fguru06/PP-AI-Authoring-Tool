...
Make each slide distinct, logically sequenced, and specific to "${u}".`,N}let f=`Create a ${{general:"well-structured educational slide with title, key points, and a takeaway",intro:"introduction slide — purpose, motivation, and what learners will achieve",overview:"overview slide — high-level map of all topics to be covered",concept:"concept slide — definition, how it works, and why it matters",example:"example slide — real-world case study or worked example with outcome",summary:"summary slide — recap key points and reinforce the main message",callout:"callout slide — single critical insight or action item"}[ie.value]||"educational slide"} about "${u}".`;return j.value.trim()&&(f+=`
...
Each option must be meaningfully different in teaching style and structure.`,f=await q.generate(o,{type:"creativeOptions",topic:u,slideType:ie.value});if(f)try{const N=JSON.parse(f.replace(/```json\n?/g,"").replace(/```\n?/g,"").trim());if(!Array.isArray(N))throw new Error("Options must be an array");U.value=N.slice(0,3).map((g,ue)=>({title:String((g==null?void 0:g.title)||`Option ${ue+1}`),angle:String((g==null?void 0:g.angle)||""),prompt:String((g==null?void 0:g.prompt)||"")})).filter(g=>g.prompt.trim()),U.value.length||(Y.value="No usable creative options were returned. Try generating again.")}catch{Y.value="Could not parse creative options. Try again or switch to “Show on Slide”."}}async function Ee(u){u!=null&&u.prompt&&(_.value=u.prompt,ce.value=!0,D.value="slide",await Ne())}async function Oe(){if(!je.value.trim()||!T.projectId||!T.currentSlideId)return;const u=await q.transformSourceTextToSlideContent(je.value,{topic:R.value,slideType:ie.value,description:j.value,layoutMode:ee.value,customPrompt:_.value});if(!u)return;const o=Ve(u),f=Ge(Ae.value),N={x:Math.max(24,Math.round(f.minX)),y:Math.max(24,Math.round(f.minY))};Ae.value.forEach(g=>{a.deleteElement(T.projectId,T.currentSlideId,g.id)}),v.value=JSON.stringify(o,null,2),m(T.projectId,T.currentSlideId,o,{origin:N})}async function De(u=!1){if(!Le.value.trim()&&!Ie.value.trim())return;u||(ne.value=[]);const o=await q.generateQuiz(Le.value,G.value,{difficulty:K.value,questionType:de.value,objective:le.value,customPrompt:Ie.value});if(o)if(u){const f=new Set(ne.value.map(g=>g.question)),N=o.filter(g=>!f.has(g.question)).map(g=>({...g,_selected:!0}));ne.value=[...ne.value,...N]}else ne.value=o.map(f=>({...f,_selected:!0}))}async function re(){const u=ne.value.filter(f=>f._selected);if(!u.length)return;const o=T.projectId;u.forEach((f,N)=>{const g=a.addSlide(o);g&&(a.addElement(o,g.id,"quiz",{x:60,y:80,width:840,height:380,content:{question:f.question,options:f.options,correctIndex:f.correctIndex,explanation:f.explanation||""}}),a.updateSlide(o,g.id,{title:`Q${N+1}: ${f.question.slice(0,40)}…`}))}),ne.value=[]}function Ce(u){ne.value.forEach(o=>o._selected=u)}async function Xe(){if(!we.value.trim())return;const u=await q.generateVoiceoverScript(we.value);u&&(v.value=u)}async function Fe(){var f,N;const u=(N=(f=xe.value)==null?void 0:f.content)==null?void 0:N.text;if(!u)return;const o=await q.generateTranslation(u,$e.value);o&&(v.value=o)}async function _e(){!v.value||!xe.value||a.updateElement(T.projectId,T.currentSlideId,xe.value.id,{content:{...xe.value.content,text:v.value}})}const ze=B(""),tt=B(!1);function ct(u){return String(u||"").replace(/```(json)?\n?/gi," ").replace(/```/g," ").replace(/[\r\n]+/g," ").replace(/\s+/g," ").trim().slice(0,220)}function vt(u,o){return new Promise((f,N)=>{const g=window.setTimeout(()=>{N(new Error("Timed out"))},o);Promise.resolve(u).then(ue=>{window.clearTimeout(g),f(ue)}).catch(ue=>{window.clearTimeout(g),N(ue)})})}function It(u){const o=String(u||"").trim(),f=o.toLowerCase();return o?f.includes("billing hard limit")||f.includes("billing")||f.includes("quota")||f.includes("insufficient_quota")?"Your OpenAI account cannot generate images right now because its billing or quota limit has been reached. Update billing in OpenAI, then try again.":f.includes("invalid api key")||f.includes("incorrect api key")||f.includes("unauthorized")?"The OpenAI API key appears invalid for image generation. Check the key in API settings and try again.":f.includes("rate limit")||f.includes("too many requests")?"OpenAI rate-limited the image request. Wait a moment and try again.":`OpenAI image generation failed: ${o}`:"OpenAI image generation did not return an image. Try a simpler prompt or try again in a moment."}async function Nt(){if(ze.value.trim()){tt.value=!0,v.value="Preparing image prompt...";try{if(!q.apiKey||q.apiProvider!=="openai"){v.value="AI image generation requires an OpenAI API key in API settings. No fallback image was inserted.";return}let u=ze.value;try{const f=await vt(q.generateImagePrompt(ze.value),2200);f&&(u=f.replace(/```(json)?\n?/g,"").trim())}catch{u=ze.value}u=ct(u)||ct(ze.value),v.value="Generating image and inserting it on the slide...";const o=await vt(q.generateImageAsset(u),2e4).catch(()=>null);if(!o){v.value=It(q.lastError);return}a.addElement(T.projectId,T.currentSlideId,"image",{x:60,y:150,width:420,height:280,content:{src:o,fallbackSrcs:[],alt:ze.value.trim()||"AI generated image",sourceType:"openai-image",objectFit:"cover"}}),v.value="AI image added to slide using OpenAI image generation."}catch(u){v.value=It((u==null?void 0:u.message)||q.lastError)}finally{tt.value=!1}}}async function zt(){var o,f;if(!((f=(o=xe.value)==null?void 0:o.content)!=null&&f.text))return;const u=await q.improveText(xe.value.content.text,M.value||"Make it clearer and more engaging");u&&(v.value=u)}async function Bt(){!v.value||!xe.value||a.updateElement(T.projectId,T.currentSlideId,xe.value.id,{content:{...xe.value.content,text:v.value}})}async function _t(){if(!M.value.trim())return;const u=await q.generate(M.value);u&&(v.value=u)}return(u,o)=>{var f,N,g,ue,Te,Ke;return l(),i("div",_p,[e("div",Lp,[(l(),i(Z,null,ve([{id:"generate",label:"✦ Content"},{id:"quiz",label:"✅ Quiz"},{id:"voiceover",label:"🎙 Voiceover"},{id:"improve",label:"✏️ Improve"},{id:"translate",label:"🌐 Translate"},{id:"image",label:"🎨 Image"},{id:"settings",label:"⚙ API"}],E=>e("button",{key:E.id,class:J(["ai-mode-btn",C.value===E.id&&"active"]),onClick:Ze=>C.value=E.id},k(E.label),11,jp)),64))]),e("div",Dp,[C.value==="generate"?(l(),i(Z,{key:0},[e("div",qp,[o[36]||(o[36]=e("label",{class:"form-label"},[X("Topic / Subject "),e("span",{class:"required"},"*")],-1)),pe(e("input",{"onUpdate:modelValue":o[0]||(o[0]=E=>R.value=E),class:"input",placeholder:"e.g. Automotive Braking System, Photosynthesis…",onKeydown:$n(Ne,["enter"])},null,544),[[ke,R.value]])]),e("div",Rp,[e("button",{class:J(["output-mode-btn",ae.value==="single"&&"active"]),onClick:o[1]||(o[1]=E=>ae.value="single")},"Single Slide",2),e("button",{class:J(["output-mode-btn",ae.value==="deck"&&"active"]),onClick:o[2]||(o[2]=E=>ae.value="deck")},"Slide Deck",2)]),ae.value==="single"?(l(),i("div",Op,[o[38]||(o[38]=e("label",{class:"form-label"},"Slide Type",-1)),pe(e("select",{"onUpdate:modelValue":o[3]||(o[3]=E=>ie.value=E),class:"select"},[...o[37]||(o[37]=[et('<option value="general" data-v-7d597454>General</option><option value="intro" data-v-7d597454>Introduction</option><option value="overview" data-v-7d597454>Overview</option><option value="concept" data-v-7d597454>Concept Explanation</option><option value="example" data-v-7d597454>Example / Case Study</option><option value="summary" data-v-7d597454>Summary</option><option value="callout" data-v-7d597454>Key Takeaway</option>',7)])],512),[[Mt,ie.value]])])):V("",!0),ae.value==="single"?(l(),i("div",Fp,[e("div",Up,[o[39]||(o[39]=e("label",{class:"form-label"},"Layout",-1)),e("span",Vp,k(he.value.hint),1)]),e("div",Wp,[(l(),i(Z,null,ve(s,E=>e("button",{key:E.id,class:J(["layout-preset-card",ee.value===E.id&&"active"]),onClick:Ze=>ee.value=E.id},[e("span",Hp,k(E.label),1),e("span",Yp,k(E.hint),1)],10,Gp)),64))])])):(l(),i("div",Qp,[o[40]||(o[40]=e("label",{class:"form-label"},"Number of Slides",-1)),pe(e("input",{"onUpdate:modelValue":o[4]||(o[4]=E=>S.value=E),class:"input",type:"number",min:"1",max:"20"},null,512),[[ke,S.value,void 0,{number:!0}]]),o[41]||(o[41]=e("p",{class:"form-hint"},"Generates this many slides from one full prompt.",-1))])),ae.value==="deck"?(l(),i("div",Jp,[e("div",Xp,[o[42]||(o[42]=e("label",{class:"form-label"},"Deck Layouts",-1)),e("span",Kp,k(be.value==="mixed"?"AI can vary layout by slide":`All slides use ${he.value.label}`),1)]),e("div",Zp,[e("button",{class:J(["output-mode-btn",be.value==="mixed"&&"active"]),onClick:o[5]||(o[5]=E=>be.value="mixed")},"Mixed Layouts",2),e("button",{class:J(["output-mode-btn",be.value==="single"&&"active"]),onClick:o[6]||(o[6]=E=>be.value="single")},"Consistent Layout",2)])])):V("",!0),ae.value==="deck"&&be.value==="single"?(l(),i("div",ev,[e("div",tv,[o[43]||(o[43]=e("label",{class:"form-label"},"Deck Layout",-1)),e("span",ov,k(he.value.hint),1)]),e("div",nv,[(l(),i(Z,null,ve(s,E=>e("button",{key:`deck-${E.id}`,class:J(["layout-preset-card",ee.value===E.id&&"active"]),onClick:Ze=>ee.value=E.id},[e("span",iv,k(E.label),1),e("span",av,k(E.hint),1)],10,lv)),64))])])):V("",!0),e("div",sv,[o[44]||(o[44]=e("label",{class:"form-label"},[X("Description "),e("span",{class:"optional"},"(optional)")],-1)),pe(e("textarea",{"onUpdate:modelValue":o[7]||(o[7]=E=>j.value=E),class:"textarea",style:{"min-height":"64px",resize:"vertical"},placeholder:"Add context, audience level, specific subtopics, tone, or any extra detail…"},null,512),[[ke,j.value]])]),e("div",rv,[e("div",uv,[o[46]||(o[46]=e("label",{class:"form-label"},"AI Prompt",-1)),ce.value?(l(),i("button",{key:0,class:"prompt-reset-btn",onClick:Pe,title:"Reset to auto-generated prompt"},[...o[45]||(o[45]=[e("svg",{width:"11",height:"11",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.5"},[e("path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"}),e("path",{d:"M3 3v5h5"})],-1),X(" Reset ",-1)])])):(l(),i("span",dv,"auto"))]),pe(e("textarea",{"onUpdate:modelValue":o[8]||(o[8]=E=>_.value=E),class:"textarea prompt-textarea",placeholder:"Describe exactly what you want the AI to create…",onInput:o[9]||(o[9]=E=>ce.value=!0),spellcheck:"false"},null,544),[[ke,_.value]]),o[47]||(o[47]=e("p",{class:"form-hint"},"Edit freely — the AI will follow your exact instructions.",-1))]),ae.value==="single"?(l(),i("div",cv,[e("button",{class:J(["output-mode-btn",D.value==="slide"&&"active"]),onClick:o[10]||(o[10]=E=>D.value="slide")},"Show on Slide",2),e("button",{class:J(["output-mode-btn",D.value==="options"&&"active"]),onClick:o[11]||(o[11]=E=>D.value="options")},"Creative Options",2)])):V("",!0),ae.value==="single"&&je.value?(l(),i("div",pv,[e("div",vv,[o[48]||(o[48]=e("span",{class:"form-label"},"Selected Text Source",-1)),e("span",fv,k(Ae.value.length)+" selected",1)]),e("div",mv,k(je.value),1),e("div",gv,[e("button",{class:"btn btn-secondary btn-sm",disabled:$(q).isGenerating,onClick:Oe}," Transform Selection to "+k(he.value.label),9,bv)])])):V("",!0),e("button",{class:"btn btn-primary w-full ai-generate-btn",disabled:$(q).isGenerating||!R.value.trim()&&!_.value.trim()||ae.value==="deck"&&(!S.value||S.value<1||S.value>20),onClick:Ne},[$(q).isGenerating?(l(),i("span",yv)):(l(),i("svg",xv,[...o[49]||(o[49]=[e("path",{d:"M13 2L3 14h9l-1 8 10-12h-9l1-8z"},null,-1)])])),X(" "+k($(q).isGenerating?"Generating…":ae.value==="deck"?v.value?`Regenerate ${S.value} Slides`:`Generate ${S.value} Slides`:D.value==="slide"?v.value?"Regenerate & Apply":"Generate & Apply":"Generate Creative Options"),1)],8,hv),ae.value==="single"&&D.value==="options"&&(U.value.length||Y.value)?(l(),i("div",wv,[e("div",kv,[o[50]||(o[50]=e("span",{class:"form-label"},"Creative Options",-1)),e("button",{class:"btn btn-ghost btn-sm",onClick:o[12]||(o[12]=E=>{U.value=[],Y.value=""})},"Clear")]),Y.value?(l(),i("div",Cv,[o[51]||(o[51]=e("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[e("circle",{cx:"12",cy:"12",r:"10"}),e("line",{x1:"12",y1:"8",x2:"12",y2:"12"}),e("line",{x1:"12",y1:"16",x2:"12.01",y2:"16"})],-1)),X(" "+k(Y.value),1)])):(l(),i("div",$v,[(l(!0),i(Z,null,ve(U.value,(E,Ze)=>(l(),i("article",{key:Ze,class:"creative-option-card"},[e("h4",Sv,k(E.title),1),e("p",Iv,k(E.angle),1),e("button",{class:"btn btn-secondary btn-sm",onClick:gt=>Ee(E)},"Use This Option",8,Av)]))),128))]))])):V("",!0)],64)):C.value==="quiz"?(l(),i(Z,{key:1},[e("div",Mv,[o[52]||(o[52]=e("label",{class:"form-label"},[X("Quiz Topic "),e("span",{class:"required"},"*")],-1)),pe(e("input",{"onUpdate:modelValue":o[13]||(o[13]=E=>Le.value=E),class:"input",placeholder:"e.g. World War II Timeline, Photosynthesis, SQL Joins…",onKeydown:$n(De,["enter"])},null,544),[[ke,Le.value]])]),e("div",Ev,[e("div",Pv,[o[54]||(o[54]=e("label",{class:"form-label"},"Questions",-1)),pe(e("select",{"onUpdate:modelValue":o[14]||(o[14]=E=>G.value=E),class:"select"},[...o[53]||(o[53]=[e("option",{value:2},"2",-1),e("option",{value:3},"3",-1),e("option",{value:4},"4",-1),e("option",{value:5},"5",-1),e("option",{value:6},"6",-1),e("option",{value:8},"8",-1),e("option",{value:10},"10",-1)])],512),[[Mt,G.value,void 0,{number:!0}]])]),e("div",Tv,[o[56]||(o[56]=e("label",{class:"form-label"},"Difficulty",-1)),pe(e("select",{"onUpdate:modelValue":o[15]||(o[15]=E=>K.value=E),class:"select"},[...o[55]||(o[55]=[e("option",{value:"beginner"},"Beginner",-1),e("option",{value:"intermediate"},"Intermediate",-1),e("option",{value:"advanced"},"Advanced",-1)])],512),[[Mt,K.value]])])]),e("div",Nv,[o[57]||(o[57]=e("label",{class:"form-label"},"Question Type",-1)),e("div",zv,[(l(),i(Z,null,ve([{id:"multiple-choice",label:"Multiple Choice",icon:"☑"},{id:"true-false",label:"True / False",icon:"✓✗"},{id:"mixed",label:"Mixed",icon:"⊕"}],E=>e("button",{key:E.id,class:J(["qtype-btn",de.value===E.id&&"active"]),onClick:Ze=>de.value=E.id},[e("span",_v,k(E.icon),1),e("span",null,k(E.label),1)],10,Bv)),64))])]),e("div",Lv,[o[58]||(o[58]=e("label",{class:"form-label"},[X("Learning Objective "),e("span",{class:"optional"},"(optional)")],-1)),pe(e("input",{"onUpdate:modelValue":o[16]||(o[16]=E=>le.value=E),class:"input",placeholder:"e.g. Identify key causes of WWI"},null,512),[[ke,le.value]])]),e("div",jv,[e("div",Dv,[o[60]||(o[60]=e("label",{class:"form-label"},"AI Prompt",-1)),ye.value?(l(),i("button",{key:0,class:"prompt-reset-btn",onClick:A,title:"Reset to auto-generated prompt"},[...o[59]||(o[59]=[e("svg",{width:"11",height:"11",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2.5"},[e("path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"}),e("path",{d:"M3 3v5h5"})],-1),X(" Reset ",-1)])])):(l(),i("span",qv,"auto"))]),pe(e("textarea",{"onUpdate:modelValue":o[17]||(o[17]=E=>Ie.value=E),class:"textarea prompt-textarea",placeholder:"Describe what quiz questions you want the AI to create…",onInput:o[18]||(o[18]=E=>ye.value=!0),spellcheck:"false"},null,544),[[ke,Ie.value]]),o[61]||(o[61]=e("p",{class:"form-hint"},"Edit this prompt freely. The AI will follow your exact instructions.",-1))]),e("button",{class:"btn btn-primary w-full ai-generate-btn",disabled:$(q).isGenerating||!Le.value.trim()&&!Ie.value.trim(),onClick:o[19]||(o[19]=E=>De(!1))},[$(q).isGenerating?(l(),i("span",Ov)):(l(),i("svg",Fv,[...o[62]||(o[62]=[e("path",{d:"M13 2L3 14h9l-1 8 10-12h-9l1-8z"},null,-1)])])),X(" "+k($(q).isGenerating?"Generating…":`Generate ${G.value} Questions`),1)],8,Rv),ne.value.length?(l(),i("div",Uv,[e("div",Vv,[e("span",Wv,k(ne.value.length)+" Questions",1),e("div",Gv,[e("button",{class:"btn btn-ghost btn-sm",onClick:o[20]||(o[20]=E=>Ce(!0))},"All"),e("button",{class:"btn btn-ghost btn-sm",onClick:o[21]||(o[21]=E=>Ce(!1))},"None"),e("button",{class:"btn btn-ghost btn-sm danger",onClick:o[22]||(o[22]=E=>ne.value=[])},"Clear")])]),e("div",Hv,[e("button",{class:"btn btn-secondary regen-btn",disabled:$(q).isGenerating,onClick:o[23]||(o[23]=E=>De(!1)),title:"Replace all questions with a new set"},[$(q).isGenerating?(l(),i("span",Qv)):(l(),i("svg",Jv,[...o[63]||(o[63]=[e("path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"},null,-1),e("path",{d:"M3 3v5h5"},null,-1)])])),o[64]||(o[64]=X(" Regenerate ",-1))],8,Yv),e("button",{class:"btn btn-ghost regen-btn",disabled:$(q).isGenerating,onClick:o[24]||(o[24]=E=>De(!0)),title:"Generate more and append to current list"},[...o[65]||(o[65]=[e("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[e("line",{x1:"12",y1:"5",x2:"12",y2:"19"}),e("line",{x1:"5",y1:"12",x2:"19",y2:"12"})],-1),X(" Add More ",-1)])],8,Xv)]),(l(!0),i(Z,null,ve(ne.value,(E,Ze)=>(l(),i("div",{key:Ze,class:J(["quiz-card",{deselected:!E._selected}])},[e("div",Kv,[e("label",Zv,[pe(e("input",{type:"checkbox","onUpdate:modelValue":gt=>E._selected=gt},null,8,e1),[[Pt,E._selected]]),e("span",t1,"Q"+k(Ze+1),1)]),e("div",o1,[e("span",{class:J(["badge difficulty-badge",E.difficulty])},k(E.difficulty),3),e("span",n1,k(E.type==="true-false"?"T/F":"MCQ"),1)])]),e("p",l1,k(E.question),1),e("div",i1,[(l(!0),i(Z,null,ve(E.options,(gt,bt)=>(l(),i("div",{key:bt,class:J(["q-option",bt===E.correctIndex&&"correct"])},[e("span",a1,k(["A","B","C","D"][bt]),1),e("span",null,k(gt),1),bt===E.correctIndex?(l(),i("svg",s1,[...o[66]||(o[66]=[e("polyline",{points:"20 6 9 17 4 12"},null,-1)])])):V("",!0)],2))),128))]),E.explanation?(l(),i("div",r1,[o[67]||(o[67]=e("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[e("circle",{cx:"12",cy:"12",r:"10"}),e("line",{x1:"12",y1:"16",x2:"12",y2:"12"}),e("line",{x1:"12",y1:"8",x2:"12.01",y2:"8"})],-1)),X(" "+k(E.explanation),1)])):V("",!0)],2))),128)),e("button",{class:"btn btn-primary w-full",disabled:!ne.value.filter(E=>E._selected).length,onClick:re},[o[68]||(o[68]=e("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[e("path",{d:"M12 5v14M5 12l7 7 7-7"})],-1)),X(" Add "+k(ne.value.filter(E=>E._selected).length)+" Selected as Quiz Slides ",1)],8,u1)])):V("",!0)],64)):C.value==="voiceover"?(l(),i(Z,{key:2},[e("div",d1,[o[69]||(o[69]=e("label",{class:"form-label"},"Slide Content / Key Points",-1)),pe(e("textarea",{"onUpdate:modelValue":o[25]||(o[25]=E=>we.value=E),class:"textarea",style:{"min-height":"100px"},placeholder:"Paste the slide content or talking points here…"},null,512),[[ke,we.value]])]),e("button",{class:"btn btn-primary w-full ai-generate-btn",disabled:$(q).isGenerating,onClick:Xe},[$(q).isGenerating?(l(),i("span",p1)):V("",!0),X(" "+k($(q).isGenerating?"Generating…":"Generate Script"),1)],8,c1)],64)):C.value==="improve"?(l(),i(Z,{key:3},[(N=(f=xe.value)==null?void 0:f.content)!=null&&N.text?(l(),i("div",v1,[o[70]||(o[70]=e("div",{class:"form-label",style:{"margin-bottom":"var(--space-1)"}},"Selected Text",-1)),e("div",f1,k(xe.value.content.text.slice(0,120))+k(xe.value.content.text.length>120?"…":""),1)])):(l(),i("p",m1,"Select a text element on the canvas to improve it.")),e("div",g1,[o[71]||(o[71]=e("label",{class:"form-label"},"Instruction",-1)),pe(e("input",{"onUpdate:modelValue":o[26]||(o[26]=E=>M.value=E),class:"input",placeholder:"Make it more concise and engaging"},null,512),[[ke,M.value]])]),o[72]||(o[72]=e("div",{class:"tab-section-title",style:{"margin-bottom":"var(--space-3)"}},"Or send a custom prompt:",-1)),pe(e("textarea",{"onUpdate:modelValue":o[27]||(o[27]=E=>M.value=E),class:"textarea",style:{"min-height":"70px"},placeholder:"Write anything…"},null,512),[[ke,M.value]]),e("button",{class:"btn btn-primary w-full ai-generate-btn",disabled:$(q).isGenerating||!xe.value&&!M.value,onClick:o[28]||(o[28]=E=>xe.value?zt():_t())},[$(q).isGenerating?(l(),i("span",h1)):V("",!0),X(" "+k($(q).isGenerating?"Processing…":"Generate"),1)],8,b1)],64)):C.value==="translate"?(l(),i(Z,{key:4},[(ue=(g=xe.value)==null?void 0:g.content)!=null&&ue.text?(l(),i("div",y1,[o[73]||(o[73]=e("div",{class:"form-label",style:{"margin-bottom":"var(--space-1)"}},"Selected Text",-1)),e("div",x1,k(xe.value.content.text.slice(0,120))+k(xe.value.content.text.length>120?"…":""),1)])):(l(),i("p",w1,"Select a text element on the canvas to translate it.")),e("div",k1,[o[75]||(o[75]=e("label",{class:"form-label"},"Target Language",-1)),pe(e("select",{"onUpdate:modelValue":o[29]||(o[29]=E=>$e.value=E),class:"select"},[...o[74]||(o[74]=[et('<option value="Spanish" data-v-7d597454>Spanish</option><option value="French" data-v-7d597454>French</option><option value="German" data-v-7d597454>German</option><option value="Italian" data-v-7d597454>Italian</option><option value="Portuguese" data-v-7d597454>Portuguese</option><option value="Chinese (Simplified)" data-v-7d597454>Chinese (Simplified)</option><option value="Japanese" data-v-7d597454>Japanese</option><option value="Arabic" data-v-7d597454>Arabic</option>',8)])],512),[[Mt,$e.value]])]),e("button",{class:"btn btn-primary w-full ai-generate-btn",disabled:$(q).isGenerating||!((Ke=(Te=xe.value)==null?void 0:Te.content)!=null&&Ke.text),onClick:Fe},[$(q).isGenerating?(l(),i("span",$1)):V("",!0),X(" "+k($(q).isGenerating?"Translating…":"Translate Text"),1)],8,C1),v.value?(l(),i("div",S1,[e("div",I1,[o[76]||(o[76]=e("span",{class:"form-label"},"Translation Result",-1)),e("div",A1,[e("button",{class:"btn btn-ghost btn-sm",onClick:o[30]||(o[30]=E=>u.navigator.clipboard.writeText(v.value))},"Copy"),e("button",{class:"btn btn-primary btn-sm",onClick:_e,disabled:!xe.value},"Apply",8,M1)])]),e("div",E1,k(v.value),1)])):V("",!0)],64)):C.value==="image"?(l(),i(Z,{key:5},[o[80]||(o[80]=e("p",{class:"ai-hint",style:{"margin-bottom":"var(--space-3)"}},"Generate distinct educational visual assets instantly. The image will be added directly to your slide.",-1)),!$(q).apiKey||$(q).apiProvider!=="openai"?(l(),i("div",P1,[...o[77]||(o[77]=[e("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[e("circle",{cx:"12",cy:"12",r:"10"}),e("line",{x1:"12",y1:"8",x2:"12",y2:"12"}),e("line",{x1:"12",y1:"16",x2:"12.01",y2:"16"})],-1),X(" AI image generation needs an OpenAI API key in API settings. This action no longer inserts fallback photos. ",-1)])])):V("",!0),e("div",T1,[o[78]||(o[78]=e("label",{class:"form-label"},"Image Description",-1)),pe(e("textarea",{"onUpdate:modelValue":o[31]||(o[31]=E=>ze.value=E),class:"textarea",style:{"min-height":"100px"},placeholder:"Describe the image (e.g. 'A futuristic city skyline at sunset in a vibrant retro style')"},null,512),[[ke,ze.value]])]),e("button",{class:"btn btn-primary w-full ai-generate-btn",disabled:tt.value||$(q).isGenerating||!ze.value||!$(q).apiKey||$(q).apiProvider!=="openai",onClick:Nt},[tt.value||$(q).isGenerating?(l(),i("span",z1)):V("",!0),X(" "+k(tt.value||$(q).isGenerating?"Generating Image…":"Generate & Insert"),1)],8,N1),v.value?(l(),i("div",B1,[o[79]||(o[79]=e("div",{class:"result-header"},[e("span",{class:"form-label"},"Status")],-1)),e("div",_1,k(v.value),1)])):V("",!0)],64)):C.value==="settings"?(l(),i("div",L1,[e("div",j1,[o[82]||(o[82]=e("label",{class:"form-label"},"AI Provider",-1)),e("select",{value:$(q).apiProvider,class:"select",onChange:o[32]||(o[32]=E=>$(q).setProvider(E.target.value))},[...o[81]||(o[81]=[e("option",{value:"openai"},"OpenAI (GPT-4o mini)",-1),e("option",{value:"anthropic"},"Anthropic (Claude)",-1)])],40,D1)]),e("div",q1,[o[83]||(o[83]=e("label",{class:"form-label"},"API Key",-1)),e("input",{type:"password",value:$(q).apiKey,class:"input",placeholder:"sk-…",onChange:o[33]||(o[33]=E=>$(q).setApiKey(E.target.value))},null,40,R1),o[84]||(o[84]=e("p",{class:"form-hint"},"Key is stored locally in your browser. It is never sent to our servers.",-1))]),$(q).apiKey?V("",!0):(l(),i("div",O1,[...o[85]||(o[85]=[e("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[e("circle",{cx:"12",cy:"12",r:"10"}),e("line",{x1:"12",y1:"8",x2:"12",y2:"12"}),e("line",{x1:"12",y1:"16",x2:"12.01",y2:"16"})],-1),X(" Running in ",-1),e("strong",null,"demo mode",-1),X(" — sample responses only. Add your API key to use real AI generation. ",-1)])]))])):V("",!0),v.value&&C.value!=="settings"&&C.value!=="quiz"?(l(),i("div",F1,[e("div",U1,[o[86]||(o[86]=e("span",{class:"form-label"},"Result",-1)),e("button",{class:"btn btn-ghost btn-sm",onClick:o[34]||(o[34]=E=>v.value="")},"Clear")]),e("pre",V1,k(v.value),1),e("div",W1,[C.value==="generate"?(l(),i("button",{key:0,class:"btn btn-primary btn-sm",onClick:H},k(ae.value==="deck"?"Apply as Deck":"Apply to Slide"),1)):V("",!0),C.value==="generate"?(l(),i("button",{key:1,class:"btn btn-ghost btn-sm",disabled:$(q).isGenerating,onClick:Ne},[...o[87]||(o[87]=[e("svg",{width:"12",height:"12",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[e("path",{d:"M3 12a9 9 0 1 0 9-9 9.75 9.75 0 0 0-6.74 2.74L3 8"}),e("path",{d:"M3 3v5h5"})],-1),X(" Regenerate ",-1)])],8,G1)):V("",!0),C.value==="improve"&&xe.value?(l(),i("button",{key:2,class:"btn btn-primary btn-sm",onClick:Bt}," Apply to Element ")):V("",!0),e("button",{class:"btn btn-secondary btn-sm",onClick:o[35]||(o[35]=E=>{var Ze;return(Ze=u.navigator.clipboard)==null?void 0:Ze.writeText(v.value)})}," Copy ")])])):V("",!0),$(q).lastError?(l(),i("div",H1,[o[88]||(o[88]=e("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2"},[e("circle",{cx:"12",cy:"12",r:"10"}),e("line",{x1:"12",y1:"8",x2:"12",y2:"12"}),e("line",{x1:"12",y1:"16",x2:"12.01",y2:"16"})],-1)),X(" "+k($(q).lastError),1)])):V("",!0)])])}}},Q1=Qe(Y1,[["__scopeId","data-v-7d597454"]]),J1={class:"theme-manager"},X1={class:"panel-section"},K1={class:"presets-grid"},Z1=["title","onClick"],ef={class:"preset-preview"},tf={class:"preset-name"},of={class:"panel-section"},nf={class:"theme-fields"},lf={class:"form-label"},af={class:"color-row"},sf=["value","onInput"],rf=["value","onChange"],uf={class:"panel-section"},df={class:"theme-field"},cf=["value","placeholder"],pf={class:"chart-palette-preview"},vf={class:"panel-section"},ff={class:"form-group",style:{"margin-bottom":"var(--space-3)"}},mf=["value"],gf=["value"],bf={class:"form-group",style:{"margin-bottom":"var(--space-3)"}},hf=["value"],yf=["value"],xf={class:"form-group"},wf=["value"],kf={class:"panel-section"},Cf={class:"tp-chart-row"},$f={key:0,class:"apply-message success"},Sf={key:1,class:"apply-message error"},If={__name:"ThemeManager",setup(I){const s=nt(),r=lt(),c=P(()=>r.getProject(s.projectId)),p=P(()=>{var a;return((a=c.value)==null?void 0:a.theme)||{}}),h=P(()=>Sn(p.value)),y=B(""),b=B("");function L(a){r.updateProject(s.projectId,{theme:{...p.value,...a}})}const te=[{name:"Corporate Blue",primaryColor:"#1e40af",secondaryColor:"#0ea5e9",bgColor:"#f8fafc",textColor:"#0f172a",fontFamily:"Inter, sans-serif"},{name:"Vibrant Purple",primaryColor:"#6c47ff",secondaryColor:"#00c9a7",bgColor:"#ffffff",textColor:"#1a1a2e",fontFamily:"Inter, sans-serif"},{name:"Nature Green",primaryColor:"#16a34a",secondaryColor:"#84cc16",bgColor:"#f0fdf4",textColor:"#14532d",fontFamily:"Georgia, serif"},{name:"Dark Modern",primaryColor:"#818cf8",secondaryColor:"#f472b6",bgColor:"#0f172a",textColor:"#e2e8f0",fontFamily:"Inter, sans-serif"},{name:"Warm Sunset",primaryColor:"#dc2626",secondaryColor:"#f59e0b",bgColor:"#fffbeb",textColor:"#451a03",fontFamily:"Verdana, sans-serif"},{name:"Ocean Breeze",primaryColor:"#0891b2",secondaryColor:"#6366f1",bgColor:"#ecfeff",textColor:"#164e63",fontFamily:"Trebuchet MS, sans-serif"}],oe=[{label:"Inter",value:"Inter, sans-serif"},{label:"Arial",value:"Arial, sans-serif"},{label:"Georgia",value:"Georgia, serif"},{label:"Verdana",value:"Verdana, sans-serif"},{label:"Times New Roman",value:'"Times New Roman", serif'},{label:"Courier New",value:'"Courier New", monospace'},{label:"Trebuchet MS",value:'"Trebuchet MS", sans-serif'},{label:"Tahoma",value:"Tahoma, sans-serif"}];function W(a){L(a)}function me(a,C){const M=a.content||{};return a.type==="text"?{content:{...M,fontFamily:C.fontFamily||M.fontFamily,color:C.textColor||M.color}}:a.type==="heading"?{content:{...M,fontFamily:C.headingFont||C.fontFamily||M.fontFamily,color:C.textColor||M.color}}:a.type==="shape"?{content:{...M,fillColor:C.secondaryColor||M.fillColor}}:a.type==="hotspot"?{content:{...M,bgColor:C.primaryColor||M.bgColor}}:a.type==="button"?{content:{...M,bgColor:C.primaryColor||M.bgColor,textColor:"#ffffff",borderColor:"transparent",fontFamily:C.fontFamily||M.fontFamily}}:a.type==="quiz"?{content:{...M,cardBgColor:C.bgColor||M.cardBgColor,questionColor:C.textColor||M.questionColor,accentColor:C.primaryColor||M.accentColor}}:a.type==="chart"?{content:{...M,...zn(C)}}:null}function q(){L({chartPalette:""})}function T(){y.value="",b.value="";const a=s.projectId,C=c.value,M=p.value;if(!a||!C){b.value="No active project to apply theme.";return}const R=C.slides||[];let v=0;R.forEach(G=>{(G.backgroundType||"color")==="color"&&r.updateSlide(a,G.id,{backgroundType:"color",background:M.bgColor||G.background||"#ffffff"}),(G.elements||[]).forEach(ie=>{const $e=me(ie,M);$e&&(r.updateElement(a,G.id,ie.id,$e),v+=1)})}),y.value=`Applied theme to ${R.length} slide${R.length===1?"":"s"} and ${v} element${v===1?"":"s"}.`}return(a,C)=>(l(),i("div",J1,[e("div",X1,[C[4]||(C[4]=e("div",{class:"panel-title"},"Preset Themes",-1)),e("div",K1,[(l(),i(Z,null,ve(te,M=>e("div",{key:M.name,class:"preset-card",title:M.name,onClick:R=>W(M)},[e("div",ef,[e("div",{class:"pp-header",style:ge({background:M.primaryColor})},null,4),e("div",{class:"pp-body",style:ge({background:M.bgColor})},[e("div",{class:"pp-line",style:ge({background:M.textColor,opacity:.7})},null,4),e("div",{class:"pp-line",style:ge({background:M.textColor,opacity:.4,width:"60%"})},null,4)],4),e("div",{class:"pp-accent",style:ge({background:M.secondaryColor})},null,4)]),e("span",tf,k(M.name),1)],8,Z1)),64))])]),e("div",of,[C[5]||(C[5]=e("div",{class:"panel-title"},"Colors",-1)),e("div",nf,[(l(),i(Z,null,ve({primaryColor:"Primary Color",secondaryColor:"Secondary Color",bgColor:"Background",textColor:"Text Color"},(M,R)=>e("div",{class:"theme-field",key:R},[e("label",lf,k(M),1),e("div",af,[e("input",{type:"color",value:p.value[R]||"#ffffff",class:"color-input-native",onInput:v=>L({[R]:v.target.value})},null,40,sf),e("input",{value:p.value[R]||"",class:"input",onChange:v=>L({[R]:v.target.value}),style:{"font-family":"var(--font-mono)","font-size":"var(--text-xs)"}},null,40,rf)])])),64))])]),e("div",uf,[C[8]||(C[8]=e("div",{class:"panel-title"},"Chart Palette",-1)),e("div",df,[C[6]||(C[6]=e("label",{class:"form-label"},"Chart Colors",-1)),e("input",{value:p.value.chartPalette||"",class:"input",placeholder:$(ll)($(Sn)(p.value)),onChange:C[0]||(C[0]=M=>L({chartPalette:M.target.value}))},null,40,cf),e("div",pf,[(l(!0),i(Z,null,ve(h.value,(M,R)=>(l(),i("span",{key:`theme-chart-${R}`,class:"chart-palette-dot",style:ge({background:M})},null,4))),128))]),e("div",{class:"chart-palette-actions"},[e("button",{type:"button",class:"btn btn-secondary btn-sm",onClick:q},"Use auto palette")]),C[7]||(C[7]=e("div",{class:"field-hint"},"Leave blank to derive chart colors from the theme primary, secondary, background, and text colors.",-1))])]),e("div",vf,[C[12]||(C[12]=e("div",{class:"panel-title"},"Typography",-1)),e("div",ff,[C[9]||(C[9]=e("label",{class:"form-label"},"Heading Font",-1)),e("select",{value:p.value.headingFont||"Inter, sans-serif",class:"select",onChange:C[1]||(C[1]=M=>L({headingFont:M.target.value}))},[(l(),i(Z,null,ve(oe,M=>e("option",{key:M.value,value:M.value},k(M.label),9,gf)),64))],40,mf)]),e("div",bf,[C[10]||(C[10]=e("label",{class:"form-label"},"Body Font",-1)),e("select",{value:p.value.fontFamily||"Inter, sans-serif",class:"select",onChange:C[2]||(C[2]=M=>L({fontFamily:M.target.value}))},[(l(),i(Z,null,ve(oe,M=>e("option",{key:M.value,value:M.value},k(M.label),9,yf)),64))],40,hf)]),e("div",xf,[C[11]||(C[11]=e("label",{class:"form-label"},"Base Font Size",-1)),e("input",{type:"number",min:"12",max:"24",value:p.value.fontSize||16,class:"input",onChange:C[3]||(C[3]=M=>L({fontSize:+M.target.value}))},null,40,wf)])]),e("div",kf,[C[13]||(C[13]=e("div",{class:"panel-title"},"Preview",-1)),e("div",{class:"theme-preview",style:ge({background:p.value.bgColor||"#fff",fontFamily:p.value.fontFamily||"Inter, sans-serif"})},[e("div",{class:"tp-heading",style:ge({color:p.value.textColor,fontFamily:p.value.headingFont||p.value.fontFamily})}," Heading Text ",4),e("div",{class:"tp-body",style:ge({color:p.value.textColor,opacity:.7})}," Body text looks like this. Clear, readable, and well-spaced for learners. ",4),e("div",{class:"tp-btn",style:ge({background:p.value.primaryColor})},"Button",4),e("div",{class:"tp-badge",style:ge({background:p.value.secondaryColor})},"Badge",4),e("div",Cf,[(l(!0),i(Z,null,ve(h.value.slice(0,5),(M,R)=>(l(),i("span",{key:`preview-chart-${R}`,class:"tp-chart-bar",style:ge({background:M,height:`${22+R*8}px`})},null,4))),128))])],4),e("button",{class:"btn btn-primary w-full apply-theme-btn",onClick:T}," Apply Theme to Slides "),y.value?(l(),i("p",$f,k(y.value),1)):V("",!0),b.value?(l(),i("p",Sf,k(b.value),1)):V("",!0)])]))}},Af=Qe(If,[["__scopeId","data-v-da2b0ce4"]]),Mf={key:0,class:"auth-gate",style:{"text-align":"center",padding:"40px 20px"}},Ef={width:"48",height:"48",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.5",style:{opacity:"0.5","margin-bottom":"16px","margin-inline":"auto"}},Pf={style:{display:"flex","flex-direction":"column",gap:"12px","max-width":"300px",margin:"0 auto"}},Tf={class:"export-tabs tabs",style:{"overflow-x":"auto"}},Nf={class:"export-content"},zf={class:"export-options",style:{"margin-bottom":"20px"}},Bf={class:"form-group"},_f={class:"export-meta"},Lf={class:"meta-item"},jf={class:"meta-item"},Df={class:"meta-item"},qf={class:"export-options",style:{"margin-bottom":"20px"}},Rf={class:"form-group"},Of={style:{display:"flex","align-items":"center",gap:"8px","margin-top":"12px","font-size":"13px",cursor:"pointer"}},Ff={class:"export-options",style:{"margin-bottom":"20px"}},Uf={class:"form-group"},Vf={style:{display:"flex","align-items":"center",gap:"8px","margin-top":"12px","font-size":"13px",cursor:"pointer"}},Wf={class:"coming-soon"},Gf={width:"32",height:"32",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.5",style:{opacity:".4"}},Hf={key:0,class:"export-success",style:{background:"#e0f2fe",color:"#166534","border-color":"#bbf7d0"}},Yf={key:1,class:"export-success"},Qf={__name:"ExportModal",setup(I){const s=nt(),r=lt(),c=Bn(),p=P(()=>r.getProject(s.projectId)),h=B("json"),y=B(""),b=B(""),L=B(!0);Ye(p,R=>{R&&!b.value&&(b.value=R.name||"presentation")},{immediate:!0});function te(){const R=r.exportProject(s.projectId);if(!R)return;const v=new Blob([R],{type:"application/json"}),G=URL.createObjectURL(v),ie=document.createElement("a");ie.href=G,ie.download=`${b.value||"project"}.mediasurf.json`,ie.click(),URL.revokeObjectURL(G),y.value="success",setTimeout(()=>y.value="",3e3)}function oe(R,v="presentation"){return String(R).trim().replace(/[\\/:*?"<>|]/g,"").replace(/\s+/g," ").trim()||v}function W(R){return new Promise((v,G)=>{const ie=new FileReader;ie.onloadend=()=>v(ie.result),ie.onerror=()=>G(ie.error),ie.readAsDataURL(R)})}function me(R,v,G="html"){const ie=Tt(v);return`
...
`}async function T(){return M("html")}async function a(){return M("iframe")}async function C(){return M("pdf")}async function M(R="html"){var Le,K,de;const v=p.value;if(!v)return;y.value="processing";const G=R==="pdf"&&typeof window<"u"?window.open("","_blank"):null;if(R==="pdf"&&!G){y.value="error",setTimeout(()=>y.value="",3e3);return}const ie=R==="pdf"?null:new al,$e=ie?ie.folder("assets"):null;let we=0;async function j(le,ne="media"){if((!le||le.startsWith("data:")||le.startsWith("http://localhost")||le.startsWith("blob:"))&&le.startsWith("data:"))return le;try{const ye=await(await fetch(le)).blob();if(R==="pdf")return await W(ye);let z="bin";const A=ye.type;if(A.includes("image/png")?z="png":A.includes("image/jpeg")?z="jpg":A.includes("image/gif")?z="gif":A.includes("image/svg")?z="svg":A.includes("image/webp")?z="webp":A.includes("video/mp4")?z="mp4":A.includes("audio/mpeg")&&(z="mp3"),z==="bin"){const x=le.match(/\\.([a-zA-Z0-9]+)(\\?.*)?$/);x&&(z=x[1])}we++;const O=`${ne}_${we}.${z}`;return $e.file(O,ye),`assets/${O}`}catch(Ie){return console.warn("Could not fetch asset:",le,Ie),le}}const _=JSON.parse(JSON.stringify([...v.slides||[]])).sort((le,ne)=>(le.order??0)-(ne.order??0));if(L.value)for(const le of _){le.backgroundType==="image"&&le.backgroundImage&&(le.backgroundImage=await j(le.backgroundImage,"bg"));for(const ne of le.elements||[])ne.type==="image"&&((Le=ne.content)!=null&&Le.src)&&(ne.content.src=await j(ne.content.src,"img")),ne.type==="video"&&((K=ne.content)!=null&&K.src)&&!ne.content.src.includes("youtube")&&!ne.content.src.includes("youtu.be")&&(ne.content.src=await j(ne.content.src,"vid")),ne.type==="audio"&&((de=ne.content)!=null&&de.src)&&(ne.content.src=await j(ne.content.src,"aud"))}const ce=oe(b.value||v.name||"presentation"),ae={name:v.name,theme:v.theme||{},settings:v.settings||{},slides:_},ee=JSON.stringify(ae).replace(/</g,"\\u003c").replace(/>/g,"\\u003e").replace(/&/g,"\\u0026"),be=me(v.theme,v.settings,R),S=q(R),D=`<script id="lf-data" type="application/json">${ee}<\/script>`,Y=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
